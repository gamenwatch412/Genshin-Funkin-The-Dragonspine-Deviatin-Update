characterPath = 'characters/zhongli' -- Picture File name of spreadsheet (must have .xml)
characterTag = 'zhongli' -- Set this to what the sprite should be named.
...
--]]
animationData = {
    ['idle'] = {'zhongli idle', -5, 0, '', false},

    ['singLEFT'] = {'zhongli left', 5, -6, '', false},
    ['singDOWN'] = {'zhongli down', -20, -51, '', false},
    ['singUP'] = {'zhongli up', -46, 27, '', false},
    ['singRIGHT'] = {'zhongli right', -48, -7, '', false},
}
