...
class CreditsState extends MusicBeatState
{
	...
	override function create()
	{
		...
		var pisspoop:Array<Array<String>> = [ //Name - Icon name - Description - Link - BG Color
			["Genshin Funkin'"],
			['Gamenwatch412',		'gamenwatch412',		"Main programmer, charter, animator, and musician of Dragonspine Deviatin'",									'https://www.youtube.com/channel/UCC0sf7IBgsVKVM9cEpwdfLQ', 		'0xFF660066'],
			...
			['Koguchi Monou (English Version)',	 	'blank',		'Performed by PeachyFranny and Raayo',														   'https://www.youtube.com/watch?v=8za2EYuDcjE',													'0xFF00FF00'],
			['Let the Wind Tell You', 				'blank',		'Performed by花园花玲, 喵☆酱, 宴宁ccccc, and kinsen',											'https://www.youtube.com/watch?v=KrNUrgaOsCc',													 '0xFF3495EB'],
			['Hikaru Nara', 						'blank', 		'Performed by 多多, kinsen, 花玲, 喵酱, 小N, 宴宁, 鹿喑, and 萧翟',								 'https://www.youtube.com/watch?v=eF6preXfMHw',			  										  '0xFF61536A'],
			['Renai Circulation', 					'blank', 		'Performed by kinsen & 鹿喑kana', 																'https://www.youtube.com/watch?v=1YrI0y1yG_0', 													'0xFFF73838'],
			['Saikai',								'blank',		'Performed by kinsen & 鹿喑kana',																'https://www.youtube.com/watch?v=hHoBogOuxhw',													'0xFF0066FF'],
			['Vigilant Yaksha',						'blank',		'Performed by kinsen',																			'https://www.youtube.com/watch?v=Q7x746k_lM0',											       '0xFFFFFFCC'],
			['Bloom of the Wind',					'blank',		'Performed by 喵☆酱, 花园花玲, 诺亚rococonorya, and 小敢',										  'https://youtu.be/9fGmirjxliA', 																'0xFFD10616'],
			["Heaven's Map", 						'blank', 		'Performed by 多多poi and 宴宁ccccc',															 'https://www.youtube.com/watch?v=uHW9NMedm8A', 												'0xFF6475F3'],
			['Soldier, Poet, King', 				'blank', 		'Performed by Joe Zieja and Erika Harlacher',													'https://www.youtube.com/watch?v=VTiqVG1qs7M',													'FFBB1B'],
			['Celestial Destiny',					'blank',		'Song video source by MaxLevel',																'https://www.youtube.com/watch?v=Bnl8OzZ5UvM',													'42DDF5'],
			...
			['bb-panzu',			'bb-panzu',			'Ex-Programmer of Psych Engine, borrowed snow asset from Holiday mod',							'https://twitter.com/bbsub3',			'389A58'],
			[''],
			['Engine Contributors'],
