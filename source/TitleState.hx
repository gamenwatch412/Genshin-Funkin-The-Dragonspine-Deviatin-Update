...
class TitleState extends MusicBeatState
{
	...
	function startIntro()
	{
		...
		hoyoSpr = new FlxSprite(0, 280).loadGraphic(Paths.image('hoyoverse'));
		add(hoyoSpr);
		hoyoSpr.visible = false;
		hoyoSpr.setGraphicSize(Std.int(hoyoSpr.width * 0.8));
		hoyoSpr.updateHitbox();
		hoyoSpr.screenCenter(X);
		hoyoSpr.antialiasing = ClientPrefs.globalAntialiasing;
