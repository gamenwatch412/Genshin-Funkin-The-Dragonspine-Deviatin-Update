...
class DialogueBoxPsych extends FlxSpriteGroup
{
	...
	var textBoxTypes:Array<String> = ['normal', 'angry', 'albedo', 'susbedo', 'boyfriend', 'eula', 'amber', 'bennett', 'aether', 'question'];
	...
	public function new(dialogueList:DialogueFile, ?song:String = null)
	{
		...
		box = new FlxSprite(-10, 400);
		box.frames = Paths.getSparrowAtlas('speech_bubble');
		box.scrollFactor.set();
		box.antialiasing = ClientPrefs.globalAntialiasing;
		box.animation.addByPrefix('normal', 'blank speech box0', 24);
		box.animation.addByPrefix('normalOpen', 'blank speech box0', 24, false);
		box.animation.addByPrefix('angry', 'susbedo speech box0', 24);
		box.animation.addByPrefix('angryOpen', 'susbedo speech box0', 24, false);
		box.animation.addByPrefix('susbedo', 'susbedo speech box0', 24);
		box.animation.addByPrefix('susbedoOpen', 'susbedo speech box0', 24, false);
		box.animation.addByPrefix('albedo', 'albedo speech box0', 24);
		box.animation.addByPrefix('albedoOpen', 'albedo speech box0', 24, false);
		box.animation.addByPrefix('boyfriend', 'boyfriend speech box0', 24);
		box.animation.addByPrefix('boyfriendOpen', 'boyfriend speech box0', 24, false);
		box.animation.addByPrefix('eula', 'eula speech box0', 24);
		box.animation.addByPrefix('eulaOpen', 'eula speech box0', 24, false);
		box.animation.addByPrefix('amber', 'amber speech box0', 24);
		box.animation.addByPrefix('amberOpen', 'amber speech box0', 24, false);
		box.animation.addByPrefix('bennett', 'bennett speech box0', 24);
		box.animation.addByPrefix('bennettOpen', 'bennett speech box0', 24, false);
		box.animation.addByPrefix('aether', 'aether speech box0', 24);
		box.animation.addByPrefix('aetherOpen', 'aether speech box0', 24, false);
		box.animation.addByPrefix('question', 'question speech box0', 24);
		box.animation.addByPrefix('questionOpen', 'question speech box0', 24, false);
		box.animation.addByPrefix('center-normal', 'girlfriend speech box0', 24);
		box.animation.addByPrefix('center-normalOpen', 'girlfriend speech box0', 24, false);
		box.animation.addByPrefix('center-angry', 'girlfriend speech box0', 24);
		box.animation.addByPrefix('center-angryOpen', 'girlfriend speech box0', 24, false);
	...
	public static var DEFAULT_TEXT_Y = 440;
