...
class PlayState extends MusicBeatState
{
	...
	override public function create()
	{
		...
		timeTxt.setFormat(Paths.font("zh-cn.ttf"), 32, FlxColor.WHITE, CENTER, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
		...
		// Add Kade Engine style watermark
        kadeEngineWatermark = new FlxText(4,healthBarBG.y + 50,0, SONG.song + " - " + CoolUtil.difficulties[storyDifficulty] + " | PE 0.5.2h", 16);
        kadeEngineWatermark.setFormat(Paths.font("zh-cn.ttf"), 16, FlxColor.WHITE, RIGHT, FlxTextBorderStyle.OUTLINE,FlxColor.BLACK);
		...
		scoreTxt.setFormat(Paths.font("zh-cn.ttf"), 20, FlxColor.WHITE, CENTER, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
		...
		botplayTxt.setFormat(Paths.font("zh-cn.ttf"), 32, FlxColor.WHITE, CENTER, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
		...
		if(ret != FunkinLua.Function_Stop && !transitioning) {
			...
			if (isStoryMode)
			{
				...
				if (storyPlaylist.length <= 0)
				{
					...
					if (SONG.song.toLowerCase() == 'bonechill' ){
						FlxG.switchState(new CutsceneState("mods/Genshin Funkin'/videos/dragonspinedeviatincreditsequence.mp4", CutsceneState.end));
					}
					else {
